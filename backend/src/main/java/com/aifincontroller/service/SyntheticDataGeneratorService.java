...
public class SyntheticDataGeneratorService {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (hasSettlement) {
                ...
                BigDecimal settlementAmount =
                        calculateSettlementAmount(amount, scenario);
             ...
             * The reconciliation engine must independently determine the
             * correct outcome later.
             */
    ...
    private SyntheticScenario selectScenario() {
        ...
        return scenarios[
                ThreadLocalRandom.current().nextInt(scenarios.length)
        ];
    }
    ...
    private BigDecimal calculateExpectedDifference(
        ...
        return switch (scenario) {
            case EXACT_MATCH,
                 ...
                 TIMING_DIFFERENCE,
                 MISSING_SETTLEMENT,
                 DUPLICATE -> BigDecimal.ZERO.setScale(4);
