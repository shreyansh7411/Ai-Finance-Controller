...
public interface RazorpayClient {
    ...
    Map<String, Object> getPaymentsForOrder(String orderId, int count, int skip);

    Map<String, Object> getSettlement(String settlementId);

    Map<String, Object> getSettlements(int count, int skip);

    Map<String, Object> getSettlementRecon(int year, int month, Integer day, int count, int skip);
}
